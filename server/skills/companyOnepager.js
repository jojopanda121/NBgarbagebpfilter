...
//
// 输入公司名/股票代码 → MiniMax 联网检索接地 → 10 模块买方投研报告 → Word(docx)。
...
module.exports = {
  ...
  title: "公司一页纸",
  description:
    "输入上市公司名或股票代码，自动联网检索（MiniMax web_search）生成买方视角的公司速览投研报告（10 大模块：近况/投资逻辑/竞争力/业务拆分/产销链/管理层/财务/调研大纲/估值/风险），导出 Word。数据全部检索接地，搜不到标待核实。",
  category: "research",
