...
//
// 输入一个行业名 → MiniMax 联网检索接地 → 9 模块结构化报告 → Word(docx)。
...
module.exports = {
  ...
  title: "行业一页纸",
  description:
    "输入一个行业名，自动联网检索（MiniMax web_search）生成买方视角的行业速览投研报告（9 大模块：定义/产业链/市场规模/竞争格局/壁垒/驱动/主要上市公司/风险/景气指标），导出 Word。数据全部检索接地，搜不到标待核实。",
  category: "research",
