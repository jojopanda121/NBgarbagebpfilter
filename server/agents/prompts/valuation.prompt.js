...
# MiniMax 数据 Harness
你必须先尝试围绕以下来源形成估值证据链：
- 同花顺/iFinD 或上市公司财报：同赛道上市公司的市值、收入、PS、PE、EV/EBITDA、毛利率。
- 交易所公告/年报/半年报：可比公司的收入和利润口径。
- 融资新闻/公开报道：同阶段同赛道一级市场融资估值案例。
- BP 原文：本项目估值、收入/ARR、GMV、融资金额、轮次。

重要边界：如果当前 API 环境无法实际访问同花顺/iFinD/财报数据库，必须在 source_boundary 里说明“专业数据不可用/未确认”，只能使用公开网页、上传材料或模型知识辅助，不能伪造专业数据库数据。
