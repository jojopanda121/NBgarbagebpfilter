    ...
    <div className="max-w-2xl mx-auto">
      ...
      {!emailBound && (
        <div className="mb-6 p-5 rounded-xl bg-amber-500/10 border border-amber-500/30 text-center">
          ...
          <p className="text-sm text-[#2D3D54] mb-3">绑定邮箱后即可开始分析商业计划书</p>
          <button
      ...
      <div className="text-center mb-6 sm:mb-8">
        ...
        <p className="text-[#2D3D54] mb-4">
          MiniMax M2.5 将扮演行业专家 + 投资专家，深度研究 BP 中每条声明，逐条核查真实性
        </p>
        <div className="inline-flex items-center gap-2 px-4 py-2 bg-[#E9EDF6] rounded-full border border-[#CBD1E0]/50">
        ...
        className={`
          ...
          ${
            dragOver
              ...
              : "border-[#CBD1E0] hover:border-[#A8B0C8] bg-white"
          }
        `}
      >
        <input
        ...
        {file ? (
          ...
          <div className="flex flex-col items-center gap-3">
            <Upload className="w-12 h-12 text-[#526078]" />
            <p className="text-lg text-[#2D3D54]">
              拖拽 PDF 到此处，或点击选择文件
            </p>
            <p className="text-sm text-[#526078]">支持文字版和扫描版 PDF</p>
          </div>
        )}
      </div>
        ...
        className={`
          ...
          ${
            file && !analyzing && emailBound
              ? "bg-gradient-to-r from-red-500 to-orange-500 hover:from-red-600 hover:to-orange-600 text-[#0C1A30] shadow-lg shadow-red-500/20"
              : "bg-[#E9EDF6] text-[#526078] cursor-not-allowed"
          }
        `}
      >
        {analyzing ? (
      ...
      {!analyzing && (
        <div className="mt-8 text-center">
          <p className="text-xs text-[#526078]">Powered by MiniMax M2.5 · DeepThink 深度研究引擎 · 提取30000字符</p>
        </div>
      )}
    </div>
  );
