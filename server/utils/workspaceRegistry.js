...
const HOST_DEFINITION = {
  ...
  description: "拆解任务、制定执行计划、调度专家和工具、选择模板产物，并把专家意见收敛成投不投、什么条件投、下一步怎么做。",
...
const TOOL_REGISTRY = {
  web_search: {
    label: "公开信息检索",
    category: "research",
    executor: "bocha_web_search",
    callableByModel: true,
    allowedCallers: ["host", "market_deal", "product_team_risk"],
    description: "通过博查 Web Search API 执行公开网络检索，用于最新市场、政策、竞品、监管、负面新闻核验。本系统没有同花顺/天眼查等专业数据库直连，专业口径数据只能靠公开网页替代并标注待核实。",
  },
  extract_document: {
    label: "文档解析",
    category: "document",
  ...
  highlight_visual: {
    ...
    allowedCallers: ["host"],
    argShape: '{"materials":"<可选，公司原始材料；留空则用项目上下文>","company_hint":"<可选，公司全称>"}',
    description: "调用视觉生成服务生成 1 页投资亮点视觉信息图 JPEG。适合微信、邮件、FA 批量转发的视觉化项目摘要。",
  },
  project_brief: {
    label: "项目简报 3 页 deck",
    category: "artifact",
