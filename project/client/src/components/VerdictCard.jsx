...
const VerdictCard = memo(function VerdictCard({ result }) {
  ...
  return (
    <div className="bg-white border border-[#CBD1E0] rounded-2xl p-5 sm:p-8">
      <div className="flex flex-col md:flex-row items-center gap-6 sm:gap-8">
        <div className="text-center">
          <div className="relative w-36 h-36 mx-auto">
            ...
            <div className="absolute inset-0 flex flex-col items-center justify-center">
              ...
              <span className="text-xs text-[#526078]">/ 100</span>
            </div>
          </div>
        ...
        <div className="flex-1 text-center md:text-left">
          ...
          <p className="text-base text-[#0C1A30] mb-3">
          ...
          {result.elapsed_seconds && (
            <p className="text-sm text-[#526078] mt-2">分析耗时 {result.elapsed_seconds}s</p>
          )}
