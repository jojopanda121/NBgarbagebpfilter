    ...
    <div className="bg-slate-900 border border-white/10 rounded-2xl p-6 sm:p-8 max-w-md mx-auto">
      ...
      {step === 1 && (
        <form onSubmit={handleSendCode} className="space-y-4">
          ...
          <div>
            <label className="block text-sm text-slate-400 mb-1">邮箱地址</label>
            <div className="relative">
              ...
              <input
                ...
                className="w-full pl-10 pr-4 py-2 bg-slate-800 border border-white/10 rounded-lg focus:outline-none focus:border-blue-500 text-white"
          ...
          <div>
            ...
            <div className="flex gap-2">
              <input
                ...
                className="flex-1 px-4 py-2 bg-slate-800 border border-white/10 rounded-lg focus:outline-none focus:border-blue-500 text-white text-center tracking-widest"
                placeholder="6位验证码"
                maxLength={6}
                required
              />
              <button
                ...
                className="px-3 py-2 bg-slate-700 hover:bg-slate-600 disabled:opacity-50 rounded-lg text-sm whitespace-nowrap"
              >
      ...
      {step === 3 && (
        <div className="text-center space-y-4">
          ...
          <p className="text-slate-300">密码已重置成功，请使用新密码登录。</p>
          <button
