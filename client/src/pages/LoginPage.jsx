  ...
  return (
    <div className="min-h-screen bg-[#F6F7FA] text-[#0F1C36] flex flex-col items-center justify-center px-4 relative">
      ...
      <div className="flex items-center gap-3 mb-8 relative z-10">
        <LogoE size={48} />
        <div>
          <h1 className="text-2xl font-bold text-[#0D2145] font-serif-cn">BP过滤机</h1>
          <p className="text-[12px] text-[#8E9BB0] font-mono-fin tracking-wide">
      ...
      <p className="mt-6 text-sm text-[#8E9BB0] text-center max-w-sm relative z-10">
        注册即送免费 BP 深度分析额度
      </p>
    </div>
  );
